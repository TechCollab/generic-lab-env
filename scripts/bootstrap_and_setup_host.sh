...
_gnrl_assert_file_exists "playbooks/requirements.yml"
ok_msg "Running \"ansible-galaxy install --force -r playbooks/requirements.yml\"" 
ansible-galaxy install --force -r playbooks/requirements.yml || { true; }
